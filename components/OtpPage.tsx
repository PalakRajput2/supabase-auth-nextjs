...
export default function OtpPage() {
  ...
  // Get email from localStorage (only once, on mount)
  useEffect(() => {
    if (typeof window !== "undefined") {
      ...
      if (storedEmail) {
        ...
        // redirect safely (replace prevents back button issues)
  ...
  return (
    <div className="flex items-center justify-center mt-10">
      <form
        ...
        className="space-y-4 p-6 bg-white rounded-md shadow-md w-full max-w-md"
      >
